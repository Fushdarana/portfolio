    ...
    return (
        < >
            ...
            <motion.p
                ...
                учебу с&nbsp;JavaScript, развиваюсь в&nbsp;области Frontend. Хочу попробовать себя
                в&nbsp;комерческой разработке, поэтому ищу возможности сотрудничества и&nbsp;работы в&nbsp;команде. Более
                уверенно себя чувствую при работе с Vue/Vuex/Nuxt, &nbsp;но свое обучение начинала с React, так что с ним также знакома.
            </motion.p>
        </>
